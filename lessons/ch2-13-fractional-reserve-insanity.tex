...
Lad mig gentage den mest vigtige del: Banker kan låne penge ud, som de faktisk ikke har.
...
\begin{center}
  ...
  \captionof{figure}{Yellen er stærkt imod revision af Fed, mens Bitcoin Sign Guy stærkt er tilhænger af at købe bitcoin.}
  \label{fig:bsg}
\end{center}
